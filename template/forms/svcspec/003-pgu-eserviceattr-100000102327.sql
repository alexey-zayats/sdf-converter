...
begin
    ...
    VALUES ((select eservice_id from GOVSRVREG.eservice where eservice_extid='100000102327'), 'INFOMAT_NOT_SUPPORTED', 'BOOL', 'Y', null, null, null) ;

    INSERT INTO GOVSRVREG.ESERVICEATTR (ESERVICE_ID, ESERVICEATTR_NAME, ESERVICEATTR_TYPE, ESERVICEATTR_BOOLVALUE, ESERVICEATTR_STRVALUE, ESERVICEATTR_LONGVALUE, ESERVICEATTR_DATEVALUE)
    VALUES ((select eservice_id from GOVSRVREG.eservice where eservice_extid='100000102327'), 'frguCardForMpULDisabled', 'BOOL', 'Y', null, null, null) ;
