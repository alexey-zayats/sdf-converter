...
"typ":"http://epgu.rtlabs.ru/equeue/ws/types/",
"wsu":"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurityutility-1.0.xsd"}/>
<#assign resp = appData />
<#assign msg = xml["//smev:Message"]/>
<ap:getSlotsResponse xmlns:ap="http://epgu.rtlabs.ru/equeue/ws/"
...
VALUES('EQUEUE_100000102511_getSlots_getSlots', request_tpl, response_tpl);
NSI.PKG_REFREGISTRY.MODIFY_WSCONFIG(
ws_conf_code => 'EQUEUE_100000102511_getSlots', -- nsi.ws_config.WS_CONFIG_CODE
uddi_key  => 'equeue_100000102511',  -- Ключ юди: equeue_мнемоникаСервисаЭО
ws_protocol => 'MR_2_5',
soap_action => 'getSlots',
ws_sign_reg =>  'Y'
);
commit;
end;
