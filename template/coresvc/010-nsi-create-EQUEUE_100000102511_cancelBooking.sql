...
<#assign req = xml["//eq:cancelBookingRequest"]/>
...
<ap:cancelBookingResponse xmlns:ap="http://epgu.rtlabs.ru/equeue/ws/"
...
</ap:cancelBookingResponse>@';

BEGIN
DELETE FROM nsi.ws_template WHERE ws_template_code = 'EQUEUE_100000102511_cancelBooking_cancelBooking';
INSERT INTO nsi.ws_template(ws_template_code, ws_request_template, ws_response_template)
VALUES('EQUEUE_100000102511_cancelBooking_cancelBooking', request_tpl, response_tpl);
NSI.PKG_REFREGISTRY.MODIFY_WSCONFIG(
ws_conf_code => 'EQUEUE_100000102511_cancelBooking', -- nsi.ws_config.WS_CONFIG_CODE
uddi_key  => 'equeue_100000102511',  -- Ключ юди: equeue_мнемоникаСервисаЭО
ws_protocol => 'MR_2_5',
soap_action => 'cancelBooking',
ws_sign_reg =>  'Y'
);
commit;
end;
