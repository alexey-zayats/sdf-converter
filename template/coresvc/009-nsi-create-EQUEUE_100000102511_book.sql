...
<ap:bookResponse xmlns:ap="http://epgu.rtlabs.ru/equeue/ws/"
...
BEGIN
DELETE FROM nsi.ws_template WHERE ws_template_code = 'EQUEUE_100000102511_book_book';
INSERT INTO nsi.ws_template(ws_template_code, ws_request_template, ws_response_template)
VALUES('EQUEUE_100000102511_book_book', request_tpl, response_tpl);
NSI.PKG_REFREGISTRY.MODIFY_WSCONFIG(
ws_conf_code => 'EQUEUE_100000102511_book', -- nsi.ws_config.WS_CONFIG_CODE
